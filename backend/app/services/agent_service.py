...
SYSTEM_PROMPT = (
    ...
    "after the user has explicitly confirmed in their own message. Once the summary "
    "has been shown, ANY affirmative user reply (yes / confirm / go ahead / book it) "
    "IS that confirmation — you MUST then call book_flight with confirm=true "
    "immediately, never ask them to confirm a second time. A booking is "
